...
| `cloudflare.trace`                                                                       | Get the IP address by parsing Cloudflare’s debugging page. The updater will automatically fail over between `https://api.cloudflare.com/cdn-cgi/trace`, `https://1.1.1.1/cdn-cgi/trace`, `https://1.0.0.1/cdn-cgi/trace`, and `https://cloudflare.com/cdn-cgi/trace` for resiliency. **This is the default provider.**                                                                                                                                                                                                                 |
